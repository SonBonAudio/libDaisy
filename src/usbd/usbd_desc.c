...
#define USBD_MANUFACTURER_STRING  "Cantux Research LLC"
// HS
#define USBD_PID_HS 0x0CE4
#define USBD_PRODUCT_STRING_HS  "eCorder Y Series"
#define USBD_CONFIGURATION_STRING_HS "MIDI Config"
#define USBD_INTERFACE_STRING_HS "MIDI Interface"
// FS
#define USBD_PID_FS 0x0CE4
#define USBD_PRODUCT_STRING_FS  "eCorder Y Series"
